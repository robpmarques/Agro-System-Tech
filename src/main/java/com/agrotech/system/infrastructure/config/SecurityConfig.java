    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/api/sensor-plans/**").hasAnyRole("OPERADOR", "ADMIN")
                    .requestMatchers("/api/readings", "/api/readings/**").hasAnyRole("OPERADOR", "ADMIN")
                            .requestMatchers("/api/alerts", "/api/alerts/**").hasAnyRole("OPERADOR", "ADMIN")
                    .requestMatchers("/api/users/admin/**").hasRole("ADMIN")
                    .requestMatchers("/api/users/especialista/**").hasRole("ADMIN")
                    .requestMatchers("/api/users/operador/**").hasAnyRole("OPERADOR", "ADMIN")
